@include('partials.header')
    ...
    <div class="row">
        <div class="col-xs-12">
            <h4><span id="activeIndex">1</span> of <span id="totalIndex"></span> {{ $query['animal'] }}s in Zip Code: {{ $query['zipcode'] }}</h4>
        </div>
...
<script>
    ...
    function getPets(){
        querySent = true;
        $.getJSON( "{{ url('pet/get/'.$query['zipcode'].'/'.$query['animal'].'/') }}/"+ pets.length )
            .done(function(data) {
